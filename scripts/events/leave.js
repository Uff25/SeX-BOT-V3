        ...
        onStart: async ({ threadsData, message, event, api, usersData, getLang }) => {
                ...
                try {
                        ...
                        message.send(form, (err, info) => {
                                if (err || !info) return;
                                if (!global.GoatBot.leaveMessageMap) global.GoatBot.leaveMessageMap = new Map();
                                global.GoatBot.leaveMessageMap.set(info.messageID, leftParticipantFbId);
                                setTimeout(() => global.GoatBot.leaveMessageMap?.delete(info.messageID), 3600000);
                        });
